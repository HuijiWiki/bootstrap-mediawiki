/**
 * Created by huiji001 on 2015/10/29.
 */

var xuanran = '<script id="vs" type="x-shader/x-vertex">'+
    'varying vec2 vUv;'+
    'void main() {'+
    'vUv = uv;'+
...
function init() {
    ...
    var texture = THREE.ImageUtils.loadTexture( '/resources/feed/cloud10.png', null, animate );
