                                ...
                                <div class="userloginForm">
                                    <form name="userlogin" method="post">
                                        ...
                                        <div class="mw-ui-vform-field api-login">
                                            <span>联合登录</span>
                                            <a href="https://api.weibo.com/oauth2/authorize?client_id=2445834038&redirect_uri=http%3A%2F%2Fhuiji.wiki%2Fwiki%2Fspecial%3Acallbackweibo&response_type=code" class="icon-weibo-share"></a>
