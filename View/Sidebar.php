    ...
    <ul class="sidebar-nav" id="sidebar-content">
        ...
        <li class="sidebar-brand left-tool">
            ...
            <ul>
                ...
                <?php } ?>
                <li><a href="http://www.huiji.wiki/wiki/帮助讨论:用户手册" class="upload-a-file" rel="nofollow"><i class="fa fa-question-circle"></i> 求助提问</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?php echo $url_prefix; ?>Mediawiki:Edittools" class="bootstrap-subnav" rel="nofollow"><i class="fa fa-bolt"></i> 修改快速插入项</a></li>
